...
% b) Flipping images. Create a copy of A and rotate the image 180 degrees.
% Store your result in B. Do *NOT* use the flipup() or fliplr() function.
%
% Write your code here:
B = A(end:1,end:1,:);
